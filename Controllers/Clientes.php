...
class Clientes extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            <button class="btn btn-danger" type="button" onclick="btnEliminarCli(' . $data[$i]['id'] . ');"><i class="fas fa-toggle-off"></i></button>  
            </div>';
            } else {
    ...
    public function registrar()
    {
        ...
        if (!empty($verificar) || $id_user == 20) {
            ...
            $msg = "Sin permisos para resgitrar cliente";
        }
    ...
    public function reingresar(int $id)
    {
        ...
        if ($data == 1) {
            ...
            $msg = "Erorr al REINGRESAR cliente";
        }
        echo json_encode($msg, JSON_UNESCAPED_UNICODE);
        die();
    }
